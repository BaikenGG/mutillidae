...
<!--
	...
	};// end function onSubmitOfLoginForm(/*HTMLFormElement*/ theForm) listo
//-->
</script>

<link rel="stylesheet" href="styles/css/styles_login.css">
<div id="id-log-in-form-div" style="display: none; text-align:auto; height: 100%;">
  <div class="container">
	...
	<form 	action="index.php?page=login.php"
		...
		<table>
			...
			<tr>
				...
				<td>
					<input	class="form-control" placeholder="Ingrese su Usuario"type="text" name="username" size="20"
							autofocus="autofocus"
					<?php
			...
			<tr>
				...
				<td>
					<input  class="form-control" placeholder="Ingrese su Contraseña"type="password" name="password" size="20"
					<?php
						if ($lEnableHTMLControls) {
							echo('minlength="1" maxlength="15" required="required"');
						}// end if
			...
			<tr>
				<td colspan="2" style="text-align:center;">
					<input name="login-php-submit-button" class="btn btn-block ingresar" type="submit" value="Login" />
				</td>
			</tr>
			<tr><td></td></tr>
			<tr>
				<td colspan="2" style="text-align:center; font-style: italic;">
					No tienes un usuario? <a href="index.php?page=register.php">Registrate aqui</a>
				</td>
			</tr>
		</table>
	</form>
...
<div id="id-log-out-div" style="text-align: center; display: none;">
	<table>
		<tr>
			<td colspan="2" class="hint-header">Cerrando sesión... haga click para continuar <?php echo $_SESSION['logged_in_user']; ?></td>
		</tr>
		<tr><td></td></tr>
		<tr><td></td></tr>
		<tr>
			<td colspan="2" style="text-align:center;">
				<input class="btn btn-block ingresar" type="button" value="Logout" onclick="document.location='index.php?do=logout'" />
			</td>
		</tr>
	</table>
</div>
