...
<div class="form-group text-center pt-3">
                        <h1 class="text-light">RESTAURANDO BD</h1>

</div>
    		<div class="label" style="text-align: center;">
                <a href="index.php" style="margin-bottom:50;" >Regresar al menú principal</a></div>
            ...
            <br>
                    ...
                    <input class="btn btn-block ingresar"  type="submit"  onclick="mostrarDesc();" value="Mostrar Descripción" />
  <br>
    <br>
      <br>
<div style="display:none; " id="Visible">
