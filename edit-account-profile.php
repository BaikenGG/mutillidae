...
<div id="id-edit-account-profile-form-div" style="display: hidden; height: 100%; ">
	<div class="container">
	...
	<form	action="index.php?page=edit-account-profile.php" method="post" enctype="application/x-www-form-urlencoded"
		...
		<table>
			...
			<tr>
				...
				<td>
					<input type="text" name="username" class="form-control" size="15" autofocus="autofocus"
						<?php
			...
			<tr>
				...
				<td>
					<input type="password" name="password" class="form-control" size="15" 
						<?php
							if ($lEnableHTMLControls) {
								echo('minlength="1" maxlength="15" required="required"');
							}// end if
			...
			<tr>
				...
				<td>
					<input type="password" name="confirm_password" class="form-control" size="15"
						<?php
							if ($lEnableHTMLControls) {
								echo('minlength="1" maxlength="15" required="required"');
							}// end if
			...
			<tr>
				...
				<td>
					<textarea rows="3" cols="50" name="my_signature" class="form-control"  
						<?php
							if ($lEnableHTMLControls) {
			...
			<tr>
				<td colspan="2" style="text-align:center;">
					<input name="edit-account-profile-php-submit-button" class="btn btn-block ingresar" type="submit" value="Update Profile" />
					<a href="index.php?page=password-generator.php&username=<?php echo $logged_in_user ?>" target="_blank" class="btn btn-block ingresar" style="width:325PX; ">Generar contraseña</a>
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
		</table>
